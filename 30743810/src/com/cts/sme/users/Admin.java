...
public class Admin {
    ...
    private void performOperations(Scanner input) throws MovieNotFoundException, ShowTimeNotFoundException, InvalidDateTimeFormatException {
        while (true) {
            displayMenu();
            int choice = getChoice(input);
            input.nextLine();
            switch (choice) {
                case 1: addMovie(input); break;
                case 2: viewAllMovies(); break;
                case 3: getMovieById(input); break;
                case 4: updateMovieById(input); break;
                case 5: deleteMovieById(input); break;
                case 6: addShowtime(input); break;
                case 7: viewAllShowtimes(); break;
                case 8: getShowtimeById(input); break;
                case 9: updateShowtimeById(input); break;
                case 10: deleteShowtimeById(input); break;
                case 11: return;
