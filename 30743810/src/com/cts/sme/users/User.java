...
public class User {
	...
	public void operations(User current_user, Scanner input) throws BookingNotFoundException, ShowTimeNotFoundException, MovieNotFoundException {
        ...
        while (true) {
            ...
            try {
                switch (choice) {
                    ...
                    case 2: // movie details by id for showtime availability
                        ...
                        input.nextLine();
                        Showtime movieAvail = showTime.getShowtimeByMovieId(movie_id);
                        if (movieAvail == null)
                    ...
                    case 5: // get all bookings
                        ...
                        if(bookings.isEmpty())
                        	throw new BookingNotFoundException("No Bookings are made");
                        else
            ...
            } catch (ShowTimeNotFoundException | BookingNotFoundException e) {
